...
fn main() {
    ...
    export_schema_with_title(
        &schema_for!(ExecuteMsg<Extension, NameServerExecuteMsg>),
        &out_dir,
        "ExecuteMsg",
    );
    export_schema(&schema_for!(QueryMsg<NameServerQueryMsg>), &out_dir);
    export_schema_with_title(
    ...
    export_schema(&schema_for!(NameServerQueryMsg), &out_dir);
    export_schema(&schema_for!(NameServerExecuteMsg), &out_dir);
}
